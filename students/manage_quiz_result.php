          ...
          <div class="row purchace-popup">
            <div class="col-12">
              <span class="d-block d-md-flex align-items-center">
                <p class="text-muted"><i class="far fa-question-circle bred-icons"></i> <span class="bred-line">/</span>Quiz Results</p>
              </span>
            </div>
          </div>
          <div class="row">
                  ...
                  <div class="table-responsive">
                    <table id="dtBasicExample" class="table table-striped table-bordered" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        <?php
                        $userid = $_SESSION['sid'];
                        $query = mysqli_query($sql_con,"SELECT *, id AS id FROM quizresult where userid = '$userid' GROUP BY id");
