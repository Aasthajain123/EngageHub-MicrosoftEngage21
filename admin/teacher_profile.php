          ...
          <div class="row purchace-popup">
            <div class="col-12">
              <span class="d-block d-md-flex align-items-center">
                <p class="text-muted"><i class="fa fa-users bred-icons"></i> <span class="bred-line">/</span> Teachers</p>
              </span>
            </div>
          </div>
          <div class="row">
                    ...
                    <table id="dtBasicExample" class="table table-striped table-bordered" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="update_teacher_profile.php?value=<?php echo $row['id']?>" class="btn btn-outline-primary btn-rounded"><i class="fa fa-edit"></i></a>
