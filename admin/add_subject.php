          ...
          <div class="row purchace-popup">
            <div class="col-12">
              <span class="d-block d-md-flex align-items-center">
                <p class="text-muted"><i class="fas fa-book bred-icons"></i> <span class="bred-line">/</span> Add Subject</p>
              </span>
            </div>
          </div>
              ...
              <div class="panel panel2">
                <form class="update-pro-form" method="post" action="">
                  <label>Select Department</label>
                      ...
                      <input name="subject" type="text" class="col-sm-12 form-control" placeholder="Enter subject" required="true"></input><br>
                <center>
