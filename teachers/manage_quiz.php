                  ...
                  <div class="table-responsive">
                    <table id="dtBasicExample" class="table table-striped table-bordered" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        ...
                        $query = mysqli_query($sql_con,"SELECT *, id AS id FROM quiz where department = '$depid' GROUP BY id");
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="quiz_detail.php?value=<?php echo $subrow['id']; ?>" class="btn btn-outline-primary btn-rounded" >Details</a>
                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-footer">
                                <a href="delete_quiz.php?value=<?php echo $subrow['id']?>" class="btn btn-outline-primary btn-rounded">YES</a>
