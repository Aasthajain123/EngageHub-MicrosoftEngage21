          ...
          <div class="row purchace-popup">
            <div class="col-12">
              <span class="d-block d-md-flex align-items-center">
                <p class="text-muted"><i class="fas fa-user-clock bred-icons"></i> <span class="bred-line">/</span> Manage Semester</p>
              </span>
            </div>
          </div>
          <div class="row">
              ...
              <div class="panel panel2">
                  <div class="table-responsive">
                    <table id="dtBasicExample" class="table table-striped table-bordered" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        <?php 
                        $data = mysqli_query($sql_con,"select *from semester");
                        while ($row = mysqli_fetch_array($data)) {
                          $depid = $row['department'];
                          $secid = $row['session'];
                          $data2 = mysqli_query($sql_con,"select *from departments where id = '$depid'");
                          $row2 = mysqli_fetch_array($data2);
                          $depname = $row2['depname'];
                          $data3 = mysqli_query($sql_con,"select *from session where id = '$secid'");
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="update_semester.php?value=<?php echo $row['id']; ?>" class="btn btn-outline-primary btn-rounded" ><i class="fa fa-edit"></i></a>
                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-footer">
                                <a href="delete_semester.php?value=<?php echo $row['id']?>" class="btn btn-outline-primary btn-rounded">YES</a>
